...
class Synth90kDataset(Dataset):
    CHARS = '0123456789QWERTYUIOPASDFGHJKLZXCVBNMqwertyuiopas&dfghjklzxcvbnm {} +:\!)(/,^--۔.طصھد ٹپتبجحمورنلہاکیقفےسشغعظضذڈثّۃـچخژزڑںۂءآگي‍‌ۓؤئ'.format('\u200f')
    ...
    def _load_from_raw_files(self, root_dir, mode):
        mapping = {}
        with open(os.path.join(root_dir, 'lexicon.txt'), 'r', encoding="utf8") as fr:
